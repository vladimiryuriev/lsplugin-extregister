...
<script type='text/javascript' src='{$aTemplateWebPathPlugin.extregister}js/register.js'></script>
...
<label for="question">{$aLang.registration_question}</label><br />
            ...
            <p><input type="text" class="input-wide" name="question" id="question" value="{$_aRequest.question}"/></p><br />
{/if}
<div class="extregister">
        ...
        <div class="extregister_license">
                ...
                <p><input type="text" class="input-wide" name="captcha_name" value="" maxlength="6" /></p>
        </div>
        <div class="clear"></div>
</div>